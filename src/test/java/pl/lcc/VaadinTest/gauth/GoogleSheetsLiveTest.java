...
public class GoogleSheetsLiveTest {
    ...
    private static final String SPREADSHEET_ID = "1dsimGchWMynaOsNMDQXgJcCg-_7N_laNfuBGvfCTtT8";
    ...
    public void whenUpdateSpreadSheetTitle_thenOk() throws IOException {
        ...
        CopyPasteRequest copyRequest = new CopyPasteRequest().setSource(new GridRange().setSheetId(0).setStartColumnIndex(0).setEndColumnIndex(2).setStartRowIndex(0).setEndRowIndex(1))
                .setDestination(new GridRange().setSheetId(1943893531).setStartColumnIndex(0).setEndColumnIndex(2).setStartRowIndex(0).setEndRowIndex(1)).setPasteType("PASTE_VALUES");
